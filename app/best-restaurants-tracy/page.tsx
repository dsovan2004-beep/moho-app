...
export const metadata = {
  ...
  openGraph: {
    ...
    description:
      'Top-rated local restaurants in Tracy, CA — verified by your neighbors in the 209.',
    url: 'https://www.moholocal.com/best-restaurants-tracy',
  },
}
...
async function getListings(): Promise<Business[]> {
  ...
  return [
    {
      ...
      '@type': 'ItemList',
      name: 'Best Restaurants in Tracy CA',
      description: 'Top-rated local restaurants in Tracy, CA verified by the MoHo Local community.',
      url: 'https://www.moholocal.com/best-restaurants-tracy',
    ...
    },
    {
      ...
      itemListElement: [
        ...
        { '@type': 'ListItem', position: 3, name: 'Best Restaurants in Tracy' },
      ],
    },
  ]
}
...
export default async function BestRestaurantsTracyPage() {
    ...
    <>
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <nav className="text-sm text-gray-400 mb-6 flex items-center gap-2 flex-wrap">
          ...
          <span>›</span>
          <span className="text-gray-700 font-medium">Best Restaurants</span>
        </nav>
          ...
          <div className="flex items-start gap-4">
            ...
            <div>
              ...
              <h1 className="text-2xl sm:text-3xl font-extrabold mb-2 leading-tight">
                Best Restaurants in Tracy, CA
              </h1>
              <p className="text-white/80 text-sm leading-relaxed">
                {listings.length} verified local restaurants — sorted by community reviews.
              </p>
            </div>
          </div>
        </div>
        ...
        <p className="text-gray-600 text-sm leading-relaxed mb-8">
          Tracy has grown from a quiet San Joaquin County town into a city of over 100,000 residents — and its restaurant scene has grown with it. You'll find everything from neighborhood taquerias and family-owned Filipino spots to pizza joints and sit-down American grills. These are all real businesses verified by the MoHo Local community. No chain filler, no ghost listings.
        </p>
        ...
        <div className="rounded-2xl p-6 text-center text-white" style={{ background: CITY_GRADIENT }}>
          ...
          <p className="text-white/80 text-sm mb-4">Get listed for free — reach thousands of local residents searching for places to eat.</p>
