...
export const metadata = {
  title: 'Best Hair Salons in Tracy CA — Local Stylists & Barbers | MoHo Local',
  description:
    "Find the best hair salons and barbershops in Tracy, CA. Browse verified local stylists, colorists, and barbers in San Joaquin County.",
  openGraph: {
    title: 'Best Hair Salons in Tracy CA',
    description: 'Top-rated hair salons and barbershops in Tracy, CA — verified picks from your neighbors in the 209.',
    url: 'https://www.moholocal.com/best-hair-salon-tracy',
  },
}
  ...
  return [
    {
      ...
      '@type': 'ItemList',
      name: 'Best Hair Salons in Tracy CA',
      description: 'Top-rated hair salons and barbershops in Tracy, CA verified by the MoHo Local community.',
      url: 'https://www.moholocal.com/best-hair-salon-tracy',
    ...
    },
    {
      ...
      itemListElement: [
        ...
        { '@type': 'ListItem', position: 3, name: 'Best Hair Salons in Tracy' },
      ],
    },
  ]
}
...
export default async function BestHairSalonTracyPage() {
  ...
  if (listings.length < 3) {
    return (
      <div className="max-w-4xl mx-auto px-4 py-8 text-center text-gray-500">
        ...
        <Link href="/tracy/beauty-spa" className="text-blue-600 hover:underline mt-4 inline-block">Browse Tracy Beauty & Spa →</Link>
      </div>
    )
  }
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          ...
          <div className="flex items-start gap-4">
            ...
            <div>
              ...
              <h1 className="text-2xl sm:text-3xl font-extrabold mb-2 leading-tight">
                Best Hair Salons in Tracy, CA
              </h1>
              <p className="text-white/80 text-sm leading-relaxed">
                {listings.length} verified local hair salons and barbershops.
              </p>
            </div>
          </div>
        </div>
        ...
        {isFallback && (
          <div className="bg-amber-50 border border-amber-200 rounded-xl px-5 py-3 mb-6 text-sm text-amber-800">
            💇 Showing all Tracy beauty & spa listings while we grow dedicated salon listings.
          </div>
        )}

        <p className="text-gray-600 text-sm leading-relaxed mb-8">
          Tracy has a strong community of independent hair salons and barbershops. From quick fades to color treatments and bridal styling, the local beauty scene here is deeply rooted — many stylists have been serving the same families for years. These are all verified local businesses, not national chains. Find your next go-to stylist right here in the 209.
        </p>
        ...
        <div className="rounded-2xl p-6 text-center text-white" style={{ background: CITY_GRADIENT }}>
          <p className="font-bold text-lg mb-1">Own a salon or barbershop in Tracy?</p>
          <p className="text-white/80 text-sm mb-4">Get discovered by locals looking for their next stylist — free listing on MoHoLocal.</p>
