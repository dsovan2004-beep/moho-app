...
export const metadata = {
  title: 'Best Pizza in Manteca CA — Local Pizzerias | MoHo Local',
  description:
    "Looking for pizza in Manteca, CA? Here are the top verified pizzerias and Italian restaurants in Manteca, San Joaquin County.",
  openGraph: {
    title: 'Best Pizza in Manteca CA',
    description: 'Top-rated local pizzerias in Manteca, CA — verified picks from your neighbors in the 209.',
    url: 'https://www.moholocal.com/best-pizza-manteca',
  },
}
...
const PIZZA_KEYWORDS = [
  ...
  'neapolitan', 'italian', 'pasta', 'lasagna',
]
  ...
  return [
    {
      ...
      '@type': 'ItemList',
      name: 'Best Pizza in Manteca CA',
      description: 'Top-rated local pizzerias in Manteca, CA verified by the MoHo Local community.',
      url: 'https://www.moholocal.com/best-pizza-manteca',
    ...
    },
    {
      ...
      itemListElement: [
        ...
        { '@type': 'ListItem', position: 3, name: 'Best Pizza in Manteca' },
      ],
    },
  ]
}
...
export default async function BestPizzaMantecaPage() {
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        {isFallback && (
          <div className="bg-amber-50 border border-amber-200 rounded-xl px-5 py-3 mb-6 text-sm text-amber-800">
            🍕 Showing all Manteca restaurants while we grow dedicated pizza listings.
          </div>
        )}

        <p className="text-gray-600 text-sm leading-relaxed mb-8">
          Manteca has a strong local identity — and a serious appetite for good pizza. The city has a mix of family-owned Italian restaurants and pizza joints that have been feeding the community for years. You will find everything from classic pies to specialty options, all from real verified businesses that Manteca residents trust.
        </p>
        ...
        <div className="rounded-2xl bg-gray-50 border border-gray-200 p-6 mb-8">
          ...
          <div className="flex flex-wrap gap-3">
            ...
            <Link href="/best-breakfast-manteca"
              className="bg-white rounded-xl border border-gray-200 px-4 py-3 text-sm font-semibold text-gray-800 hover:border-orange-300 hover:text-orange-800 transition">
              🍳 Best Breakfast in Manteca
            </Link>
          </div>
        </div>

        <div className="rounded-2xl p-6 text-center text-white" style={{ background: CITY_GRADIENT }}>
          <p className="font-bold text-lg mb-1">Own a pizza spot or Italian restaurant in Manteca?</p>
          <p className="text-white/80 text-sm mb-4">Get listed for free — reach Manteca families searching for pizza tonight.</p>
