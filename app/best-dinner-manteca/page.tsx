...
export const metadata = {
  title: 'Best Dinner in Manteca CA — Top Evening Restaurants | MoHo Local',
  description:
    "Looking for a great dinner in Manteca, CA? Browse top-rated local restaurants open for dinner in Manteca, San Joaquin County.",
  openGraph: {
    title: 'Best Dinner in Manteca CA',
    description: 'Top dinner restaurants in Manteca, CA — verified picks from your neighbors in the 209.',
    url: 'https://www.moholocal.com/best-dinner-manteca',
  },
}
  ...
  return [
    {
      ...
      '@type': 'ItemList',
      name: 'Best Dinner in Manteca CA',
      description: 'Top dinner restaurants in Manteca, CA verified by the MoHo Local community.',
      url: 'https://www.moholocal.com/best-dinner-manteca',
    ...
    },
    {
      ...
      itemListElement: [
        ...
        { '@type': 'ListItem', position: 3, name: 'Best Dinner in Manteca' },
      ],
    },
  ]
}
...
export default async function BestDinnerMantecaPage() {
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        {isFallback && (
          <div className="bg-amber-50 border border-amber-200 rounded-xl px-5 py-3 mb-6 text-sm text-amber-800">
            🌙 Showing top Manteca restaurants while we grow dedicated dinner listings.
          </div>
        )}

        <p className="text-gray-600 text-sm leading-relaxed mb-8">
          Manteca is a city with real community spirit — and that shows up at the dinner table. Whether you are after a hearty Mexican meal, a good grill spot, or something more adventurous, the local restaurant scene delivers. These verified listings represent real businesses where Manteca families actually eat on a Friday night.
        </p>
        ...
        <div className="rounded-2xl bg-gray-50 border border-gray-200 p-6 mb-8">
          ...
          <div className="flex flex-wrap gap-3">
            ...
            <Link href="/best-lunch-manteca"
              className="bg-white rounded-xl border border-gray-200 px-4 py-3 text-sm font-semibold text-gray-800 hover:border-orange-300 hover:text-orange-800 transition">
              🥗 Best Lunch in Manteca
            </Link>
