...
export const metadata = {
  title: 'Best Dentists in Tracy CA — Verified Dental Offices | MoHo Local',
  description:
    "Looking for a dentist in Tracy, CA? Here are the top verified dental offices and orthodontists serving Tracy and San Joaquin County.",
  openGraph: {
    title: 'Best Dentists in Tracy CA',
    description: 'Top verified dentists in Tracy, CA — trusted picks from your neighbors in the 209.',
    url: 'https://www.moholocal.com/best-dentists-tracy',
  },
}
  ...
  return [
    {
      ...
      '@type': 'ItemList',
      name: 'Best Dentists in Tracy CA',
      description: 'Top verified dentists and dental offices in Tracy, CA.',
      url: 'https://www.moholocal.com/best-dentists-tracy',
    ...
    },
    {
      ...
      itemListElement: [
        ...
        { '@type': 'ListItem', position: 3, name: 'Best Dentists in Tracy' },
      ],
    },
  ]
}
...
export default async function BestDentistsTracyPage() {
  ...
  if (listings.length < 3) {
    return (
      <div className="max-w-4xl mx-auto px-4 py-8 text-center text-gray-500">
        ...
        <Link href="/tracy/health-wellness" className="text-blue-600 hover:underline mt-4 inline-block">Browse Tracy Health & Wellness →</Link>
      </div>
    )
  }
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        {isFallback && (
          <div className="bg-blue-50 border border-blue-200 rounded-xl px-5 py-3 mb-6 text-sm text-blue-800">
            🦷 Showing all Tracy health & wellness listings — dental offices highlighted as more are added.
          </div>
        )}

        <p className="text-gray-600 text-sm leading-relaxed mb-8">
          Tracy is a large, growing city with a real need for quality dental care — and the local dental scene has expanded to meet it. From family general dentistry offices to orthodontists offering Invisalign, there are verified options across the city. These listings are confirmed by the MoHo Local community, so you know you are looking at practices that are actually open and serving Tracy residents.
        </p>
        ...
        <div className="rounded-2xl bg-gray-50 border border-gray-200 p-6 mb-8">
          ...
          <div className="flex flex-wrap gap-3">
            <Link href="/tracy/health-wellness"
        ...
        <div className="rounded-2xl p-6 text-center text-white" style={{ background: CITY_GRADIENT }}>
          <p className="font-bold text-lg mb-1">Run a dental practice in Tracy?</p>
