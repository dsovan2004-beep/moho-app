...
export const metadata = {
  title: 'Best Lunch in Tracy CA — Local Spots for Midday Meals | MoHo Local',
  description:
    "Where to eat lunch in Tracy, CA? Browse verified local restaurants and lunch spots in San Joaquin County.",
  openGraph: {
    title: 'Best Lunch in Tracy CA',
    description: 'Top lunch spots in Tracy, CA — verified picks from your neighbors in the 209.',
    url: 'https://www.moholocal.com/best-lunch-tracy',
  },
}
  ...
  return [
    {
      ...
      '@type': 'ItemList',
      name: 'Best Lunch in Tracy CA',
      description: 'Top lunch spots in Tracy, CA verified by the MoHo Local community.',
      url: 'https://www.moholocal.com/best-lunch-tracy',
    ...
    },
    {
      ...
      itemListElement: [
        ...
        { '@type': 'ListItem', position: 3, name: 'Best Lunch in Tracy' },
      ],
    },
  ]
}
...
export default async function BestLunchTracyPage() {
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        {isFallback && (
          <div className="bg-amber-50 border border-amber-200 rounded-xl px-5 py-3 mb-6 text-sm text-amber-800">
            🥗 Showing top Tracy restaurants while we grow dedicated lunch listings.
          </div>
        )}

        <p className="text-gray-600 text-sm leading-relaxed mb-8">
          Whether you have 30 minutes or a full hour, Tracy has options for a solid midday meal. The city has grown into a diverse food town — you can find Mexican taquerias, Vietnamese pho spots, American delis, and quick bites all within a short drive. These are real verified businesses that Tracy residents actually eat at.
        </p>
        ...
        <div className="rounded-2xl bg-gray-50 border border-gray-200 p-6 mb-8">
          ...
          <div className="flex flex-wrap gap-3">
            ...
            <Link href="/best-dinner-tracy"
              className="bg-white rounded-xl border border-gray-200 px-4 py-3 text-sm font-semibold text-gray-800 hover:border-green-300 hover:text-green-800 transition">
              🌙 Best Dinner in Tracy
            </Link>
          </div>
        </div>

        <div className="rounded-2xl p-6 text-center text-white" style={{ background: CITY_GRADIENT }}>
          <p className="font-bold text-lg mb-1">Own a lunch spot in Tracy?</p>
          <p className="text-white/80 text-sm mb-4">Get discovered by the lunch crowd — free listing on MoHoLocal.</p>
