...
export const metadata = {
  title: 'Best Nail Salons in Manteca CA — Manicure & Pedicure | MoHo Local',
  description:
    "Find the best nail salons in Manteca, CA. Verified local nail techs offering manicures, pedicures, gel, and acrylics in Manteca, San Joaquin County.",
  openGraph: {
    title: 'Best Nail Salons in Manteca CA',
    description: 'Top-rated nail salons in Manteca, CA — verified picks from your neighbors in the 209.',
    url: 'https://www.moholocal.com/best-nail-salon-manteca',
  },
}
  ...
  return [
    {
      ...
      '@type': 'ItemList',
      name: 'Best Nail Salons in Manteca CA',
      description: 'Top-rated nail salons in Manteca, CA verified by the MoHo Local community.',
      url: 'https://www.moholocal.com/best-nail-salon-manteca',
    ...
    },
    {
      ...
      itemListElement: [
        ...
        { '@type': 'ListItem', position: 3, name: 'Best Nail Salons in Manteca' },
      ],
    },
  ]
}
...
export default async function BestNailSalonMantecaPage() {
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          ...
          <div className="flex items-start gap-4">
            ...
            <div>
              ...
              <h1 className="text-2xl sm:text-3xl font-extrabold mb-2 leading-tight">
                Best Nail Salons in Manteca, CA
              </h1>
        ...
        {isFallback && (
          <div className="bg-amber-50 border border-amber-200 rounded-xl px-5 py-3 mb-6 text-sm text-amber-800">
            💅 Showing all Manteca beauty & spa listings while we grow dedicated nail salon listings.
          </div>
        )}

        <p className="text-gray-600 text-sm leading-relaxed mb-8">
          Manteca locals know where to go for a reliable nail appointment — and word spreads fast in a city with this much community energy. Whether you are after a quick walk-in mani or a full set of gel nails, Manteca has local options you can trust. These listings are all verified, meaning real businesses at real addresses.
        </p>
        ...
        <div className="rounded-2xl bg-gray-50 border border-gray-200 p-6 mb-8">
          ...
          <div className="flex flex-wrap gap-3">
            ...
            <Link href="/best-hair-salon-manteca"
              className="bg-white rounded-xl border border-gray-200 px-4 py-3 text-sm font-semibold text-gray-800 hover:border-orange-300 hover:text-orange-800 transition">
              💇 Best Hair Salons in Manteca
            </Link>
        ...
        <div className="rounded-2xl p-6 text-center text-white" style={{ background: CITY_GRADIENT }}>
          <p className="font-bold text-lg mb-1">Own a nail salon in Manteca?</p>
