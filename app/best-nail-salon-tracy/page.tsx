...
export const metadata = {
  title: 'Best Nail Salons in Tracy CA — Manicure & Pedicure | MoHo Local',
  description:
    "Find the best nail salons in Tracy, CA. Browse verified local nail techs and salons offering manicures, pedicures, gel, and acrylics in San Joaquin County.",
  openGraph: {
    title: 'Best Nail Salons in Tracy CA',
    description: 'Top-rated nail salons in Tracy, CA — verified picks from your neighbors in the 209.',
    url: 'https://www.moholocal.com/best-nail-salon-tracy',
  },
}
...
const NAIL_KEYWORDS = [
  ...
  'wax', 'polish', 'shellac', 'dip powder', 'ombre nails',
]
  ...
  return [
    {
      ...
      '@type': 'ItemList',
      name: 'Best Nail Salons in Tracy CA',
      description: 'Top-rated nail salons in Tracy, CA verified by the MoHo Local community.',
      url: 'https://www.moholocal.com/best-nail-salon-tracy',
    ...
    },
    {
      ...
      itemListElement: [
        ...
        { '@type': 'ListItem', position: 3, name: 'Best Nail Salons in Tracy' },
      ],
    },
  ]
}
...
export default async function BestNailSalonTracyPage() {
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        {isFallback && (
          <div className="bg-amber-50 border border-amber-200 rounded-xl px-5 py-3 mb-6 text-sm text-amber-800">
            💅 Showing all Tracy beauty & spa listings while we grow dedicated nail salon listings.
          </div>
        )}

        <p className="text-gray-600 text-sm leading-relaxed mb-8">
          Tracy has a growing selection of nail salons — from quick walk-in spots for a simple manicure to full-service nail studios doing gel, acrylics, and nail art. The city has enough population density now to support real competition, which means quality has gone up. These listings are all verified by the MoHo Local community. No phantom listings, no closed shops.
        </p>
        ...
        <div className="rounded-2xl p-6 text-center text-white" style={{ background: CITY_GRADIENT }}>
          <p className="font-bold text-lg mb-1">Own a nail salon in Tracy?</p>
          <p className="text-white/80 text-sm mb-4">Get discovered by locals searching for their next nail appointment — free listing on MoHoLocal.</p>
