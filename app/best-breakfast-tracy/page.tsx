...
export const metadata = {
  title: 'Best Breakfast in Tracy CA — Morning Spots & Diners | MoHo Local',
  description:
    "Looking for breakfast in Tracy, CA? Here are the top local morning spots, diners, and cafes in San Joaquin County's fastest-growing city.",
  openGraph: {
    title: 'Best Breakfast in Tracy CA',
    description: 'Top breakfast spots in Tracy, CA — verified picks from your neighbors in the 209.',
    url: 'https://www.moholocal.com/best-breakfast-tracy',
  },
}
  ...
  return [
    {
      ...
      '@type': 'ItemList',
      name: 'Best Breakfast in Tracy CA',
      description: 'Top breakfast spots and morning diners in Tracy, CA verified by the MoHo Local community.',
      url: 'https://www.moholocal.com/best-breakfast-tracy',
    ...
    },
    {
      ...
      itemListElement: [
        ...
        { '@type': 'ListItem', position: 3, name: 'Best Breakfast in Tracy' },
      ],
    },
  ]
}
...
export default async function BestBreakfastTracyPage() {
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          ...
          <div className="flex items-start gap-4">
            ...
            <div>
              ...
              <h1 className="text-2xl sm:text-3xl font-extrabold mb-2 leading-tight">
                Best Breakfast in Tracy, CA
              </h1>
              <p className="text-white/80 text-sm leading-relaxed">
                {listings.length} verified local morning spots — diners, cafes, and breakfast joints.
              </p>
            </div>
          </div>
        </div>
        ...
        {isFallback && (
          <div className="bg-amber-50 border border-amber-200 rounded-xl px-5 py-3 mb-6 text-sm text-amber-800">
            🍳 Showing top Tracy restaurants while we grow dedicated breakfast listings.
          </div>
        )}

        <p className="text-gray-600 text-sm leading-relaxed mb-8">
          Tracy is a commuter city — which means breakfast matters here. Residents heading out to the Bay Area or Sacramento want something real before they hit the highway, and the local breakfast scene delivers. From old-school diners with bottomless coffee to neighborhood cafes with fresh baked goods, these are the verified spots where Tracy starts its day.
        </p>
        ...
        <div className="rounded-2xl p-6 text-center text-white" style={{ background: CITY_GRADIENT }}>
          <p className="font-bold text-lg mb-1">Own a breakfast spot or cafe in Tracy?</p>
          <p className="text-white/80 text-sm mb-4">Get in front of the early risers — free listing on MoHoLocal.</p>
