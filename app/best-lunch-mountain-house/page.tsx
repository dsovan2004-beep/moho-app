...
export const metadata = {
  title: 'Best Lunch in Mountain House CA — Local Midday Eats | MoHo Local',
  description:
    "Where to eat lunch in Mountain House, CA? Browse verified local restaurants and lunch options in the Mountain House community.",
  openGraph: {
    title: 'Best Lunch in Mountain House CA',
    description: 'Top lunch spots in Mountain House, CA — verified picks from your neighbors in the 209.',
    url: 'https://www.moholocal.com/best-lunch-mountain-house',
  },
}
  ...
  return [
    {
      ...
      '@type': 'ItemList',
      name: 'Best Lunch in Mountain House CA',
      description: 'Top lunch spots in Mountain House, CA verified by the MoHo Local community.',
      url: 'https://www.moholocal.com/best-lunch-mountain-house',
    ...
    },
    {
      ...
      itemListElement: [
        ...
        { '@type': 'ListItem', position: 3, name: 'Best Lunch in Mountain House' },
      ],
    },
  ]
}
...
export default async function BestLunchMountainHousePage() {
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          ...
          <div className="flex items-start gap-4">
            ...
            <div>
              ...
              <h1 className="text-2xl sm:text-3xl font-extrabold mb-2 leading-tight">
                Best Lunch in Mountain House, CA
              </h1>
        ...
        {isFallback && (
          <div className="bg-blue-50 border border-blue-200 rounded-xl px-5 py-3 mb-6 text-sm text-blue-800">
            🥗 Showing all Mountain House restaurants while we grow dedicated lunch listings.
          </div>
        )}

        <p className="text-gray-600 text-sm leading-relaxed mb-8">
          Mountain House has grown fast enough that work-from-home residents now have real lunch options nearby. From quick bites to sit-down spots, the community has expanded its dining scene well beyond what early residents had access to. All listings here are verified — these are real restaurants that Mountain House neighbors have actually been to.
        </p>
