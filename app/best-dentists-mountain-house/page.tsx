        ...
        <div className="rounded-2xl bg-gray-50 border border-gray-200 p-6 mb-8">
          ...
          <div className="flex flex-col sm:flex-row gap-3">
            <Link href="/mountain-house/health-wellness"
              className="flex-1 bg-white rounded-xl border border-gray-200 px-4 py-3 text-sm font-semibold text-gray-800 hover:border-blue-300 hover:text-blue-800 transition">
