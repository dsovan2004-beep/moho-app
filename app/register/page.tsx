...
import { signInWithGoogle, signInWithFacebook, signUpWithEmail } from '@/lib/supabase'
...
// ── Google G SVG icon ─────────────────────────────────────────────────────────
function GoogleIcon({ loading }: { loading: boolean }) {
  if (loading) {
    return (
...
// ── Benefits list ─────────────────────────────────────────────────────────────
const BENEFITS = [
  { icon: '📅', text: 'Discover local events and neighborhood updates' },
  { icon: '🐾', text: 'Track lost & found pets across nearby cities' },
  { icon: '⭐', text: 'Save and review your favorite local businesses' },
  { icon: '🏘️', text: 'Connect with neighbors in Mountain House, Tracy, Lathrop, Manteca & Brentwood' },
]
      ...
      <div className="max-w-md w-full mx-auto">
        ...
        <div className="text-center mb-6">
          ...
          <p className="mt-1 text-sm text-gray-500">
            Your community hub for Mountain House, Tracy, Lathrop, Manteca &amp; Brentwood
          </p>
        </div>
        ...
        <div className="bg-white rounded-2xl shadow-md border border-gray-100 p-7">
          ...
          >
            <GoogleIcon loading={googleLoading} />
          ...
          <form onSubmit={handleEmailSignUp} className="space-y-4">
            ...
            <button
              ...
              className="w-full flex items-center justify-center gap-2 py-3 rounded-xl text-sm font-bold transition-all disabled:opacity-60 disabled:cursor-not-allowed mt-1"
              style={{ backgroundColor: '#f59e0b', color: '#1e3a5f' }}
              onMouseEnter={(e) => {
            ...
            <p className="text-xs text-gray-400 text-center pt-1">
              ...
              <a href="/terms" className="underline hover:text-gray-600 transition">Terms</a> and{' '}
